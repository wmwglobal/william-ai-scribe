...
-- Ensure only admin/owner policies exist for sessions
CREATE POLICY IF NOT EXISTS "sessions_admin_owner_only_complete_access" 
ON public.sessions 
FOR ALL 
TO authenticated
...
-- Ensure only admin/owner policies exist for utterances
CREATE POLICY IF NOT EXISTS "utterances_admin_owner_only_complete_access" 
